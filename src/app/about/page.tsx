                    ...
                    {features.map((feature, index) => {
                      ...
                      return (
                        <motion.div
                          ...
                          className="p-6 rounded-xl bg-gradient-to-br from-background/50 to-background/30 backdrop-blur-sm border border-primary/20 hover:border-primary/40 transition-all"
                        >
